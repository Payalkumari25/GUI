...
button_add = Button(root,text="+",padx=39,pady=20,command=lambda: click_add())
button_sub = Button(root,text="-",padx=41,pady=20,command=lambda: click_sub())
button_mul = Button(root,text="*",padx=40,pady=20,command=lambda: click_mul())
button_div = Button(root,text="/",padx=41,pady=20,command=lambda: click_div())
button_equal = Button(root,text="=",padx=91,pady=20,command=lambda: click_equal())
button_clear = Button(root,text="clear",padx=79,pady=20,command=lambda: click_clear())
